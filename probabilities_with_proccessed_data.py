...
all_data = pd.read_csv('preprocessed_train.csv', index_col=0, parse_dates=True)
# train_labels = pd.read_csv('labels.csv', index_col=0, parse_dates=True)
# print(all_data)
train_labels = all_data['status_group']
# del all_data['status_group']
train = all_data
...
test = pd.read_csv('preprocessed_test.csv', index_col=0, parse_dates=True)
